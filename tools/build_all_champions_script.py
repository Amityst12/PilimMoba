#!/usr/bin/env python3
"""Builds tools/gen_data.gd with balanced TTK (Time-To-Kill):
- Higher Base HP across the roster (+30% to +40%)
- Slightly higher health regen and base resistances
- Slightly tuned down early ability base damage to prevent 1-shot burst early game
- Solid scaling for late game
"""
